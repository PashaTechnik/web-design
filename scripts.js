...
function displayLab1()
{
    ...
    document.getElementById("lab-list5").hidden = true;
    document.getElementById("lab-list6").hidden = true;
}
...
function displayLab5()
{
    ...
    document.getElementById("lab-list3").hidden = true;
    document.getElementById("lab-list4").hidden = true;
    document.getElementById("lab-list5").hidden = false;
    document.getElementById("lab-list6").hidden = true;
}

function displayLab6()
{
    document.getElementById("lab-list1").hidden = true;
    document.getElementById("lab-list2").hidden = true;
    document.getElementById("lab-list3").hidden = true;
    document.getElementById("lab-list4").hidden = true;
    document.getElementById("lab-list5").hidden = true;
    document.getElementById("lab-list6").hidden = false;
}
